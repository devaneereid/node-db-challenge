...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
    ...
    The relational database will store the data, and SQL is dynamic and used to obtain access and manipulate the database.

- [ ] Why do tables need a `primary key`?

    Tables need a primary key so it can identify the uniqueness of the rows in the table. 
